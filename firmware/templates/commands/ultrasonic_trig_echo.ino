/*
 * ULTRASONIC_TRIG_ECHO Command Module
 * Reads distance from HC-SR04 sensor
 * Format: ULTRASONIC_TRIG_ECHO|TRIG_PIN|ECHO_PIN
 */
...
// === DISPATCHER ===
else if (strcmp(cmd, "ULTRASONIC_TRIG_ECHO") == 0) {
  return handleUltrasonicTrigEcho(delimiter ? delimiter + 1 : NULL);
}
