...
- [x] Фаза 1.1: Промяна на `stop()` за ADVANCED mode
- [x] Фаза 1.2: Верификация на BASIC mode (няма промяна)
- [x] Фаза 2.1: Добавяне на pause полета в схемата
- [x] Фаза 2.2: Промяна на `pause()` метода
- [x] Фаза 2.3: Създаване на PauseTimeoutService
- [x] Фаза 3.1: Промяна на Pause API endpoint
