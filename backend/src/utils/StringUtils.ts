/**
 * String manipulation utilities for Backend.
 * Centralized logic for slug generation and transliteration.
 */

/**
 * Map of Cyrillic characters to their Latin equivalents.
 * Based on standard transliteration systems used in Frontend.
 */
...
/**
 * Converts a string into a URL-friendly slug (ID).
 ...
 * 
 * Example: "Измерване на pH" -> "izmervane_na_ph"
 */
