...
export interface SystemEvents {
    ...
    'device:data': { deviceId: string; driverId?: string; deviceName?: string; value: any; raw?: any; unit?: string; readings?: Record<string, any>; details?: any; timestamp?: Date | string };
