...
async function verifyPhSmart() {
    ...
    console.log(`Input Raw: ${raw7} -> Output pH: ${res1.value} (Expected ~7.0)`);
    ...
    console.log(`Input Raw: ${raw7_12bit} (12-bit) -> Output pH: ${res2.value} (Expected ~7.0)`);
    ...
    console.log(`Input Raw: 343 (at pH 4.0 point) -> Output pH: ${res3.value} (Expected 4.0)`);
    ...
    console.log(`Input Raw: 343 (at 40°C) -> Output pH: ${res4.value} (Expected > 4.0 without comp, verified with comp logic)`);
    ...
    console.log(`Segmented Test: Acidic=${acidRes.value} | Alkaline=${alkaliRes.value}`);
